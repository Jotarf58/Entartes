...
router.patch("/:id/requisicoes/:requisicaoId/sugerir", authMiddleware, (req, res) => inventarioController.sugerirData(req, res));
router.patch("/:id/requisicoes/:requisicaoId/aceitar-sugestao", authMiddleware, (req, res) => inventarioController.aceitarSugestao(req, res));
